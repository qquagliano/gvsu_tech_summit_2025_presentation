...
- Be able to identify reasonable open-source alternatives to popular and
proprietary tools (Section: [How to Find Alternative and Open-source Tools])

- Learn about some practical implementation examples to bring more diverse
software to students in class (Section: [Examples of Integration])

- Recognize both the advantages and disadvantages of adopting open-source
alternatives into instruction (Section: Throughout [Examples of Integration])
...
1. Identify which programs and software are "industry-standard" in your field
   and which programs you would normally suggest/have students use for
assignments in the classes you instruct
...
4. Try out alternatives and see if they match your needs - you want to make sure
   that it works well enough so you would feel comfortable!
...
donation suggestions, "Contact sales"
...
(OBS)](https://obsproject.com/) - I use this for recording all of my lectures!
...
made the "wrong" choice, doubling the amount of time the assignment takes
...
- Students need to record a short introduction (to themselves) video in a class in which they
will have to do multiple recording presentations. They are asked to record once
using Panopto (Proprietary) and Open Broadcasting Software (OBS; FOSS)
...
- May easily be grating to students if assignment is too long and feels like too
much work to do twice
- Students may not see value in multiple method approach unless this is
explicitly explained when introducing assignment

## Option 3: Scavenger Hunt for Equivalent Features {#sec-scav-hunt}
...
ChatGPT, and documentation to find. Have them take screenshots showing them
"finding" the features in the open source program.
...
transparency, reproducability, and security benefits. Consider looking into
